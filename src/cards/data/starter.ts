...
const rawCards = [
  ...
  { id: 'revolving-sun', name: 'Revolving Sun', element: 'fire', text: 'Sniper. On hit: inflict Burn 1.', tags: [], wip: false, type: 'unit', cost: { energy: 2, elements: [{ type: 'fire', amount: 2 }] }, attack: 2, hp: 1, keywords: { sniper: true }, onHit: { burn: 1 } },
  ...
  { id: 'spore-bat', name: 'Spore Bat', element: 'nature', tags: [], wip: false, type: 'unit', cost: { energy: 1, elements: [{ type: 'nature', amount: 1 }] }, attack: 2, hp: 1, keywords: { airborne: true } },
  { id: 'goreivyne', name: 'Goreivyne', element: 'nature', text: 'Bloodlust: gain +0/+2 per kill.', tags: [], wip: false, type: 'unit', cost: { energy: 3, elements: [{ type: 'nature', amount: 1 }] }, attack: 3, hp: 1, keywords: { bloodlust: { buff: { attack: 0, hp: 2 } } } },
  { id: 'fearie', name: 'Fearie', element: 'nature', text: 'Airborne. Can move an enemy unit to this lane.', tags: [], wip: false, type: 'unit', cost: { energy: 1, elements: [{ type: 'nature', amount: 2 }] }, attack: 2, hp: 1, keywords: { airborne: true }, onPlay: [{ kind: 'move', target: 'enemy' }], onAttack: [], endOfTurn: [], startOfTurn: [] },
  ...
  { id: 'craftbee', name: 'Craftbee', element: 'nature', text: 'Airborne. Branch Shot.', tags: [], wip: false, type: 'unit', cost: { energy: 2, elements: [{ type: 'nature', amount: 2 }] }, attack: 3, hp: 1, keywords: { branchShot: true, airborne: true } },
  { id: 'chemister', name: 'Chemister', element: 'nature', text: 'Sniper. On hit: inflict Poison.', tags: [], wip: false, type: 'unit', cost: { energy: 2, elements: [{ type: 'nature', amount: 2 }] }, attack: 1, hp: 2, keywords: { sniper: true }, onHit: { poison: true } },
  ...
  { id: 'frost-imp', name: 'Frost Imp', element: 'water', text: 'Overshot.', tags: [], wip: false, type: 'unit', cost: { energy: 1, elements: [{ type: 'water', amount: 1 }] }, attack: 2, hp: 1, keywords: { overshot: true } },
  { id: 'river-turtle', name: 'River Turtle', element: 'water', tags: [], wip: false, type: 'unit', cost: { energy: 3, elements: [{ type: 'water', amount: 2 }] }, attack: 0, hp: 1, keywords: { shield: 1, doubleTeam: true } },
  ...
  { id: 'frost-king', name: 'Frost King', element: 'water', text: 'On play: freeze all enemies.', tags: [], wip: false, type: 'unit', cost: { energy: 8, elements: [{ type: 'water', amount: 1 }] }, attack: 2, hp: 2, keywords: {}, onPlay: [{ kind: 'applyStatus', target: 'all-enemy', status: 'freeze' }] },
  { id: 'seaweed-octopus', name: 'Seaweed Octopus', element: 'water', text: 'Aquatic. In water: can move an enemy unit to this lane.', tags: [], wip: false, type: 'unit', cost: { energy: 2, elements: [{ type: 'water', amount: 1 }] }, attack: 2, hp: 1, keywords: { aquatic: true }, onPlay: [{ kind: 'move', target: 'enemy' }], onAttack: [], endOfTurn: [], startOfTurn: [] },
  ...
  { id: 'bowling-boulder', name: 'Bowling Boulder', element: 'earth', text: 'Growth: +1/0 each turn. Polish: +0/+2 when hit.', tags: [], wip: false, type: 'unit', cost: { energy: 4, elements: [{ type: 'earth', amount: 2 }] }, attack: 1, hp: 3, keywords: { polish: { stat: { attack: 0, hp: 2 } }, growth: { attack: 1, hp: 0 } } },
  ...
  { id: 'mandrake', name: 'Mandrake', element: 'earth', text: 'Polish: when hit, debuffs all enemies −1/0.', tags: [], wip: false, type: 'unit', cost: { energy: 5, elements: [{ type: 'earth', amount: 1 }] }, attack: 1, hp: 4, keywords: { polish: { effects: [{ kind: 'debuff', target: 'enemy', stat: { attack: 1 } }] } } },
  ...
  { id: 'galatian-spirit', name: 'Galatian Spirit', element: 'earth', text: 'Taunt. On hit: inflict Poison.', tags: [], wip: false, type: 'unit', cost: { energy: 4, elements: [{ type: 'earth', amount: 2 }] }, attack: 2, hp: 4, keywords: { taunt: true }, onHit: { poison: true } },
  ...
  { id: 'mush-room', name: 'Mush Room', element: 'nature', tags: [], wip: false, type: 'spell', cost: { energy: 3, elements: [{ type: 'nature', amount: 1 }] }, effects: [{ kind: 'applyStatus', target: 'ally', status: 'trueShield' }] },
  ...
  { id: 'stone-footing', name: 'Stone Footing', element: 'earth', tags: [], wip: false, type: 'foundation', cost: { energy: 5, elements: [{ type: 'earth', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { tough: 1 } } },
  { id: 'down-under-masks', name: 'Down Under Masks', element: 'fire', tags: [], wip: false, type: 'foundation', cost: { energy: 6, elements: [{ type: 'fire', amount: 3 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { immunity: true, bloodlust: { buff: { attack: 2, hp: 1 } } } } },
  ...
  { id: 'vent', name: 'Vent', element: 'fire', text: 'All units in this lane gain Overshot.', tags: [], wip: false, type: 'environment', cost: { energy: 1, elements: [{ type: 'fire', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Overshot' }], grantKeywords: { overshot: true } },
  { id: 'graveyard', name: 'Graveyard', element: 'earth', text: 'All units gain Zombified.', tags: [], wip: false, type: 'environment', cost: { energy: 7, elements: [{ type: 'earth', amount: 1 }] }, lanes: ['ground'], effects: [{ kind: 'custom', note: 'All units gain Zombified' }], grantKeywords: { zombified: true } },
  ...
  { id: 'watchtowers', name: 'Watchtowers', element: 'earth', text: 'Heights only. All units gain Sniper.', tags: [], wip: false, type: 'environment', cost: { energy: 1, elements: [{ type: 'earth', amount: 1 }] }, lanes: ['heights'], effects: [{ kind: 'custom', note: 'All units gain Sniper' }], grantKeywords: { sniper: true } },
  { id: 'coffee-fields', name: 'Coffee Fields', element: 'nature', text: 'All units gain Double Strike.', tags: [], wip: false, type: 'environment', cost: { energy: 4, elements: [{ type: 'nature', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Double Strike' }], grantKeywords: { doubleStrike: true } },
  { id: 'perfect-fortress', name: 'Perfect Fortress', element: 'earth', text: 'All units gain True Shield.', tags: [], wip: false, type: 'environment', cost: { energy: 8, elements: [{ type: 'earth', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain True Shield' }], grantKeywords: { trueShield: true } },
  { id: 'pocket-dimension', name: 'Pocket Dimension', element: 'nature', text: 'All units gain Double Team.', tags: [], wip: false, type: 'environment', cost: { energy: 2, elements: [{ type: 'nature', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Double Team' }], grantKeywords: { doubleTeam: true } },
  { id: 'warehouse', name: 'Warehouse', element: 'earth', text: 'All units gain Growth: +1/+1.', tags: [], wip: false, type: 'environment', cost: { energy: 6, elements: [{ type: 'earth', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Growth: +1/+1' }], grantKeywords: { growth: { attack: 1, hp: 1 } } },
  ...
  { id: 'root-elder', name: 'Root Elder', element: 'nature', text: 'Producer: 2 energy/turn.', tags: [], wip: false, type: 'unit', cost: { energy: 5, elements: [{ type: 'nature', amount: 1 }] }, attack: 2, hp: 5, keywords: {}, onPlay: [], onAttack: [], endOfTurn: [{ kind: 'energyNext', amount: 2 }], startOfTurn: [] },
  { id: 'iron-seed', name: 'Iron Seed', element: 'nature', text: 'Place beneath a unit: grants +1/+1 and Growth: +1/0.', tags: [], wip: false, type: 'foundation', cost: { energy: 3, elements: [{ type: 'nature', amount: 2 }] }, attack: 2, hp: 3, keywords: {}, grants: { keywords: { growth: { attack: 1, hp: 0 } } } },
  { id: 'war-beast', name: 'War Beast', element: 'nature', text: 'Growth: +1/+1 per turn. Bloodlust: +1/0 per kill.', tags: [], wip: false, type: 'unit', cost: { energy: 4, elements: [{ type: 'nature', amount: 2 }] }, attack: 2, hp: 2, keywords: { bloodlust: { buff: { attack: 1, hp: 0 } }, growth: { attack: 1, hp: 1 } } },
  { id: 'swift-falcon', name: 'Swift Falcon', element: 'fire', text: 'Airborne. Brittle.', tags: [], wip: false, type: 'unit', cost: { energy: 1, elements: [{ type: 'fire', amount: 1 }] }, attack: 3, hp: 1, keywords: { airborne: true, brittle: true } },
  { id: 'surge-sprite', name: 'Surge Sprite', element: 'nature', text: 'Growth: +1/0 per turn. Producer: 1 energy/turn.', tags: [], wip: false, type: 'unit', cost: { energy: 2, elements: [{ type: 'nature', amount: 2 }] }, attack: 1, hp: 2, keywords: { growth: { attack: 1, hp: 0 } }, onPlay: [], onAttack: [], endOfTurn: [{ kind: 'energyNext', amount: 1 }], startOfTurn: [] },
  ...
  { id: 'spike-wall', name: 'Spike Wall', element: 'earth', text: 'Spike 1. Tough 1.', tags: [], wip: false, type: 'unit', cost: { energy: 3, elements: [{ type: 'earth', amount: 2 }] }, attack: 0, hp: 2, keywords: { spike: 1, tough: 1 } },
  ...
  { id: 'critter-token', name: 'Mechanical Failure', element: 'nature', text: 'A summoned mechanical failure. Airborne.', tags: [], wip: false, type: 'unit', cost: { energy: 1, elements: [{ type: 'nature', amount: 1 }] }, attack: 1, hp: 2, keywords: { airborne: true } },
  ...
  { id: 'abyss-warden', name: 'Abyss Warden', element: 'water', tags: [], wip: false, type: 'unit', cost: { energy: 6 }, attack: 4, hp: 5, keywords: {} },
  ...
  { id: 'granite-ox', name: 'Granite Ox', element: 'earth', tags: [], wip: false, type: 'unit', cost: { energy: 5 }, attack: 3, hp: 5, keywords: {} },
  { id: 'mountain-bull', name: 'Mountain Bull', element: 'earth', tags: [], wip: false, type: 'unit', cost: { energy: 6 }, attack: 4, hp: 5, keywords: {} },
  ...
  { id: 'comet-rider', name: 'Comet Rider', element: 'fire', text: 'Battle Ready.', tags: [], wip: false, type: 'unit', cost: { energy: 0, elements: [{ type: 'fire', amount: 1 }] }, attack: 2, hp: 1, keywords: { battleReady: true } },
  { id: 'twin-blade', name: 'Twin Blade', element: 'fire', text: 'Double Strike.', tags: [], wip: false, type: 'unit', cost: { energy: 2, elements: [{ type: 'fire', amount: 1 }] }, attack: 2, hp: 2, keywords: { doubleStrike: true } },
  { id: 'split-arrow', name: 'Split Arrow', element: 'fire', text: 'Branch Shot.', tags: [], wip: false, type: 'unit', cost: { energy: 2, elements: [{ type: 'fire', amount: 1 }] }, attack: 3, hp: 1, keywords: { branchShot: true } },
  ...
  { id: 'wildfire-spread', name: 'Wildfire Spread', element: 'fire', text: 'Inflict Burn 2 on all enemy units.', tags: [], wip: false, type: 'spell', cost: { energy: 5, elements: [{ type: 'fire', amount: 1 }] }, effects: [{ kind: 'applyStatus', amount: 2, target: 'all-enemy', status: 'burn' }] },
  { id: 'dream-eater', name: 'Dream Eater', element: 'water', text: 'Sniper. On hit: inflict Sleep.', tags: [], wip: false, type: 'unit', cost: { energy: 4, elements: [{ type: 'water', amount: 2 }] }, attack: 1, hp: 2, keywords: { sniper: true }, onHit: { sleep: 1 } },
  ...
  { id: 'lull', name: 'Lull', element: 'water', text: 'Put all enemy units to Sleep.', tags: [], wip: false, type: 'spell', cost: { energy: 5, elements: [{ type: 'water', amount: 1 }] }, effects: [{ kind: 'applyStatus', amount: 2, target: 'all-enemy', status: 'sleep' }] },
  ...
  { id: 'mind-leech', name: 'Mind Leech', element: 'water', text: 'On hit: inflict Sleep. On death: add a Dead Weight to the enemy hand.', tags: [], wip: false, type: 'unit', cost: { energy: 5, elements: [{ type: 'water', amount: 2 }] }, attack: 1, hp: 3, keywords: { kamikaze: { kind: 'conjure', target: 'enemy', cardId: 'dead-weight' } }, onHit: { sleep: 0 } },
  ...
  { id: 'brood-mother', name: 'Brood Mother', element: 'nature', text: 'On play: summon two Mechanical Failures.', tags: [], wip: false, type: 'unit', cost: { energy: 4, elements: [{ type: 'nature', amount: 2 }] }, attack: 2, hp: 3, keywords: {}, onPlay: [{ kind: 'summon', cardId: 'critter-token' }, { kind: 'summon', cardId: 'critter-token' }] },
  { id: 'hive-spawn', name: 'Hive Spawn', element: 'nature', text: 'On death: summon a Mechanical Failure.', tags: [], wip: false, type: 'unit', cost: { energy: 2, elements: [{ type: 'nature', amount: 1 }] }, attack: 2, hp: 2, keywords: { kamikaze: { kind: 'summon', cardId: 'critter-token' } } },
  { id: 'apex-predator', name: 'Apex Predator', element: 'nature', text: 'Growth: +1/+1 per turn. Bloodlust: +2/0 per kill.', tags: [], wip: false, type: 'unit', cost: { energy: 9, elements: [{ type: 'nature', amount: 2 }] }, attack: 4, hp: 5, keywords: { bloodlust: { buff: { attack: 2, hp: 0 } }, growth: { attack: 1, hp: 1 } } },
  ...
  { id: 'worldheart-wyrm', name: 'Worldheart Wyrm', element: 'nature', text: 'Strike Through. Bloodlust: +1/+1 per kill.', tags: [], wip: false, type: 'unit', cost: { energy: 16, elements: [{ type: 'nature', amount: 2 }] }, attack: 7, hp: 7, keywords: { strikeThrough: true, bloodlust: { buff: { attack: 1, hp: 1 } } } },
  { id: 'grove-elder', name: 'Elder of the Grove', element: 'nature', text: 'Producer: 2 energy/turn. On play: draw a card.', tags: [], wip: false, type: 'unit', cost: { energy: 5, elements: [{ type: 'nature', amount: 2 }] }, attack: 1, hp: 5, keywords: {}, onPlay: [{ kind: 'draw', amount: 1 }], onAttack: [], endOfTurn: [{ kind: 'energyNext', amount: 2 }], startOfTurn: [] },
  { id: 'verdant-cataclysm', name: 'Verdant Cataclysm', element: 'nature', text: 'Deal 3 damage to all enemies and heal all allies 2.', tags: [], wip: false, type: 'spell', cost: { energy: 6, elements: [{ type: 'nature', amount: 2 }] }, effects: [{ kind: 'damage', amount: 3, target: 'all-enemy' }, { kind: 'heal', amount: 2, target: 'all-ally' }] },
  ...
  { id: 'brood-warlord', name: 'Brood Warlord', element: 'nature', text: 'At end of turn: give all other allied units +1/0.', tags: [], wip: false, type: 'unit', cost: { energy: 5, elements: [{ type: 'nature', amount: 1 }] }, attack: 2, hp: 5, keywords: {}, onPlay: [], onAttack: [], endOfTurn: [{ kind: 'buff', target: 'all-ally', stat: { attack: 1, hp: 0 } }], startOfTurn: [] },
  ...
  { id: 'crag-hawk', name: 'Crag Hawk', element: 'earth', text: 'Airborne. Sniper.', tags: [], wip: false, type: 'unit', cost: { energy: 1, elements: [{ type: 'earth', amount: 2 }] }, attack: 2, hp: 2, keywords: { sniper: true, airborne: true } },
  { id: 'herd-driver', name: 'Herd Driver', element: 'nature', text: 'Each turn: move an enemy unit.', tags: [], wip: false, type: 'unit', cost: { energy: 4, elements: [{ type: 'nature', amount: 1 }] }, attack: 2, hp: 4, keywords: {}, onPlay: [], onAttack: [], endOfTurn: [], startOfTurn: [{ kind: 'move', target: 'enemy' }] },
  ...
  { id: 'spiked-base', name: 'Spiked Base', element: 'earth', text: 'Grants +0/+2 and Spike 1.', tags: [], wip: false, type: 'foundation', cost: { energy: 4, elements: [{ type: 'earth', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { spike: 1 } } },
  ...
  { id: 'ward-stone', name: 'Ward Stone', element: 'water', text: 'Grants Shield 1.', tags: [], wip: false, type: 'foundation', cost: { energy: 5, elements: [{ type: 'water', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { shield: 1 } } },
  ...
  { id: 'launch-ramp', name: 'Launch Ramp', element: 'fire', text: 'Grants Overshot and +1/0.', tags: [], wip: false, type: 'foundation', cost: { energy: 3, elements: [{ type: 'fire', amount: 2 }] }, attack: 3, hp: 3, keywords: {}, grants: { keywords: { overshot: true } } },
  { id: 'siege-platform', name: 'Siege Platform', element: 'fire', text: 'Grants Strike Through.', tags: [], wip: false, type: 'foundation', cost: { energy: 4, elements: [{ type: 'fire', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { strikeThrough: true } } },
  { id: 'forked-mount', name: 'Forked Mount', element: 'nature', text: 'Grants Branch Shot.', tags: [], wip: false, type: 'foundation', cost: { energy: 4, elements: [{ type: 'nature', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { branchShot: true } } },
  { id: 'undertow-base', name: 'Undertow Base', element: 'water', text: 'Grants Undershot.', tags: [], wip: false, type: 'foundation', cost: { energy: 5, elements: [{ type: 'water', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { undershot: true } } },
  { id: 'whetstone-altar', name: 'Whetstone Altar', element: 'earth', text: 'Grants Lethal.', tags: [], wip: false, type: 'foundation', cost: { energy: 6, elements: [{ type: 'earth', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { lethal: true } } },
  { id: 'springboard', name: 'Springboard', element: 'fire', text: 'Grants Battle Ready and +1/0.', tags: [], wip: false, type: 'foundation', cost: { energy: 2, elements: [{ type: 'fire', amount: 2 }] }, attack: 2, hp: 3, keywords: {}, grants: { keywords: { battleReady: true } } },
  { id: 'twin-perch', name: 'Twin Perch', element: 'water', text: 'Grants Double Team.', tags: [], wip: false, type: 'foundation', cost: { energy: 3, elements: [{ type: 'water', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { doubleTeam: true } } },
  { id: 'roost-nest', name: 'Roost Nest', element: 'nature', text: 'Grants Airborne.', tags: [], wip: false, type: 'foundation', cost: { energy: 2, elements: [{ type: 'nature', amount: 2 }] }, attack: 2, hp: 3, keywords: {}, grants: { keywords: { airborne: true } } },
  ...
  { id: 'reactive-plating', name: 'Reactive Plating', element: 'earth', text: 'Grants Polish: +1/0 when hit.', tags: [], wip: false, type: 'foundation', cost: { energy: 4, elements: [{ type: 'earth', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { polish: { stat: { attack: 1, hp: 0 } } } } },
  { id: 'rally-banner', name: 'Rally Banner', element: 'nature', text: 'Grants Bloodlust: +1/+1 per kill.', tags: [], wip: false, type: 'foundation', cost: { energy: 5, elements: [{ type: 'nature', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { bloodlust: { buff: { attack: 1, hp: 1 } } } } },
  { id: 'fertile-mound', name: 'Fertile Mound', element: 'nature', text: 'Grants Growth: +1/+1 per turn.', tags: [], wip: false, type: 'foundation', cost: { energy: 5, elements: [{ type: 'nature', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { growth: { attack: 1, hp: 1 } } } },
  ...
  { id: 'phylactery', name: 'Phylactery', element: 'earth', text: 'Grants Zombified.', tags: [], wip: false, type: 'foundation', cost: { energy: 5, elements: [{ type: 'earth', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { zombified: true } } },
  ...
  { id: 'twin-fang-mount', name: 'Twin Fang Mount', element: 'earth', text: 'Grants Double Strike.', tags: [], wip: false, type: 'foundation', cost: { energy: 4, elements: [{ type: 'earth', amount: 2 }] }, attack: 2, hp: 4, keywords: {}, grants: { keywords: { doubleStrike: true } } },
  ...
  { id: 'crows-nest', name: 'Crow\'s Nest', element: 'fire', text: 'Heights only. All units gain Strike Through.', tags: [], wip: false, type: 'environment', cost: { energy: 4, elements: [{ type: 'fire', amount: 1 }] }, lanes: ['heights'], effects: [{ kind: 'custom', note: 'All units gain Strike Through' }], grantKeywords: { strikeThrough: true } },
  { id: 'thornfield', name: 'Thornfield', element: 'earth', text: 'All units gain Spike 1.', tags: [], wip: false, type: 'environment', cost: { energy: 4, elements: [{ type: 'earth', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Spike 1' }], grantKeywords: { spike: 1 } },
  { id: 'fortified-line', name: 'Fortified Line', element: 'earth', text: 'Ground only. All units gain Taunt.', tags: [], wip: false, type: 'environment', cost: { energy: 2, elements: [{ type: 'earth', amount: 1 }] }, lanes: ['ground'], effects: [{ kind: 'custom', note: 'All units gain Taunt' }], grantKeywords: { taunt: true } },
  { id: 'bunker', name: 'Bunker', element: 'earth', text: 'All units gain Tough 1.', tags: [], wip: false, type: 'environment', cost: { energy: 5, elements: [{ type: 'earth', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Tough 1' }], grantKeywords: { tough: 1 } },
  { id: 'aegis-veil', name: 'Aegis Veil', element: 'water', text: 'All units gain Shield 1.', tags: [], wip: false, type: 'environment', cost: { energy: 7, elements: [{ type: 'water', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Shield 1' }], grantKeywords: { shield: 1 } },
  { id: 'sanctified-ground', name: 'Sanctified Ground', element: 'earth', text: 'All units gain Immunity.', tags: [], wip: false, type: 'environment', cost: { energy: 5, elements: [{ type: 'earth', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Immunity' }], grantKeywords: { immunity: true } },
  { id: 'killing-fields', name: 'Killing Fields', element: 'earth', text: 'All units gain Lethal.', tags: [], wip: false, type: 'environment', cost: { energy: 8, elements: [{ type: 'earth', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Lethal' }], grantKeywords: { lethal: true } },
  { id: 'thin-air', name: 'Thin Air', element: 'fire', text: 'All units gain Battle Ready.', tags: [], wip: false, type: 'environment', cost: { energy: 0, elements: [{ type: 'fire', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Battle Ready' }], grantKeywords: { battleReady: true } },
  { id: 'crossfire-range', name: 'Crossfire Range', element: 'fire', text: 'Ground only. All units gain Branch Shot.', tags: [], wip: false, type: 'environment', cost: { energy: 4, elements: [{ type: 'fire', amount: 1 }] }, lanes: ['ground'], effects: [{ kind: 'custom', note: 'All units gain Branch Shot' }], grantKeywords: { branchShot: true } },
  { id: 'high-ground', name: 'High Ground', element: 'fire', text: 'All units gain Overshot and Splash Damage.', tags: [], wip: false, type: 'environment', cost: { energy: 8, elements: [{ type: 'fire', amount: 2 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Overshot and Splash Damage' }], grantKeywords: { overshot: true, splashDamage: true } },
  { id: 'spawning-pool', name: 'Spawning Pool', element: 'nature', text: 'Ground only. All units gain Bloodlust: +1/0 per kill.', tags: [], wip: false, type: 'environment', cost: { energy: 4, elements: [{ type: 'nature', amount: 1 }] }, lanes: ['ground'], effects: [{ kind: 'custom', note: 'All units gain Bloodlust: +1/0' }], grantKeywords: { bloodlust: { buff: { attack: 1, hp: 0 } } } },
  { id: 'overgrowth', name: 'Overgrowth', element: 'nature', text: 'All units gain Growth: +1/0 per turn.', tags: [], wip: false, type: 'environment', cost: { energy: 4, elements: [{ type: 'nature', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units gain Growth: +1/0' }], grantKeywords: { growth: { attack: 1, hp: 0 } } },
  ...
  { id: 'shallows', name: 'Shallows', element: 'water', text: 'Water only. All units in this lane gain Aquatic.', tags: [], wip: false, type: 'environment', cost: { energy: 1 }, lanes: ['water'], effects: [{ kind: 'custom', note: 'All units gain Aquatic' }], grantKeywords: { aquatic: true } },
  ...
  { id: 'shifting-sands', name: 'Shifting Sands', element: 'earth', text: 'All units gain Mover (self): wander each turn.', tags: [], wip: false, type: 'environment', cost: { energy: 3, elements: [{ type: 'earth', amount: 1 }] }, lanes: [], effects: [{ kind: 'custom', note: 'All units wander each turn' }], grantKeywords: { mover: { scope: 'self', trigger: 'endOfTurn' } } },
