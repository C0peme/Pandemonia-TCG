...
const rawCards = [
  ...
  { id: 'iron-mantis', name: 'Iron Mantis', element: 'earth', text: 'Shield 2.', tags: [], wip: false, type: 'unit', cost: { energy: 5, elements: [{ type: 'water', amount: 1 }] }, attack: 1, hp: 3, keywords: { shield: 2 } },
  ...
  { id: 'bulwark-toad', name: 'Bulwark Toad', element: 'earth', text: 'Taunt. Shield 1.', tags: [], wip: false, type: 'unit', cost: { energy: 3, elements: [{ type: 'earth', amount: 1 }, { type: 'water', amount: 1 }] }, attack: 0, hp: 3, keywords: { shield: 1, taunt: true } },
