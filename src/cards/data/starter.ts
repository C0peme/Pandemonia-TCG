...
const rawCards = [
  ...
  { id: 'salt-golem', name: 'Salt Golem', element: 'earth', text: 'Polish: when hit, heals your leader +1.', tags: [], wip: false, type: 'unit', cost: { energy: 3, elements: [{ type: 'earth', amount: 1 }] }, attack: 2, hp: 5, keywords: {}, onPlay: [], onAttack: [], endOfTurn: [{ kind: 'heal', amount: 1, target: 'leader' }], startOfTurn: [] },
  ...
  { id: 'pyroclasm', name: 'Pyroclasm', element: 'fire', text: 'Deal 4 damage directly to the enemy leader, ignoring all units.', tags: [], wip: false, type: 'spell', cost: { energy: 2, elements: [{ type: 'fire', amount: 1 }] }, effects: [{ kind: 'damage', amount: 4, target: 'leader' }] },
  { id: 'mend', name: 'Mend', element: 'nature', tags: [], wip: false, type: 'spell', cost: { energy: 0, elements: [{ type: 'nature', amount: 1 }] }, effects: [{ kind: 'heal', amount: 3, target: 'ally' }] },
  { id: 'strings-of-heaven', name: 'Strings of Heaven', element: 'nature', text: 'Move an ally unit to another lane and give it +1/+1.', tags: [], wip: false, type: 'spell', cost: { energy: 1, elements: [{ type: 'nature', amount: 2 }] }, effects: [{ kind: 'move', target: 'ally' }, { kind: 'buff', target: 'ally', stat: { attack: 1, hp: 1 } }] },
  ...
  { id: 'void-caller', name: 'Void Caller', element: 'water', text: 'Deal 2 damage to all enemy units.', tags: [], wip: false, type: 'spell', cost: { energy: 3, elements: [{ type: 'water', amount: 1 }] }, effects: [{ kind: 'damage', amount: 2, target: 'all-enemy' }] },
  ...
  { id: 'mind-leech', name: 'Mind Leech', element: 'water', text: 'On hit: inflict Sleep. On death: add a Dead Weight to the enemy hand.', tags: [], wip: false, type: 'unit', cost: { energy: 3, elements: [{ type: 'water', amount: 2 }] }, attack: 1, hp: 3, keywords: { kamikaze: { kind: 'conjure', target: 'enemy', cardId: 'dead-weight' } }, onHit: { sleep: 0 } },
  ...
  { id: 'aegis-ancient', name: 'Aegis Ancient', element: 'earth', text: 'Taunt. Tough 2. At end of turn: heal your leader 2.', tags: [], wip: false, type: 'unit', cost: { energy: 5, elements: [{ type: 'earth', amount: 3 }] }, attack: 2, hp: 3, keywords: { taunt: true, tough: 2 }, onPlay: [], onAttack: [], endOfTurn: [{ kind: 'heal', amount: 2, target: 'leader' }], startOfTurn: [] },
  ...
  { id: 'verdant-cataclysm', name: 'Verdant Cataclysm', element: 'nature', text: 'Deal 3 damage to all enemies and heal all allies 2.', tags: [], wip: false, type: 'spell', cost: { energy: 8, elements: [{ type: 'nature', amount: 2 }] }, effects: [{ kind: 'damage', amount: 3, target: 'all-enemy' }, { kind: 'heal', amount: 2, target: 'all-ally' }] },
  ...
  { id: 'hivemind-surge', name: 'Hivemind Surge', element: 'nature', text: 'Give all allied units +1/+1.', tags: [], wip: false, type: 'spell', cost: { energy: 4, elements: [{ type: 'nature', amount: 1 }] }, effects: [{ kind: 'buff', target: 'all-ally', stat: { attack: 1, hp: 1 } }] },
