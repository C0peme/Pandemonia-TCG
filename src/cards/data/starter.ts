...
const rawCards = [
  ...
  { id: 'shinero', name: 'Spinero', element: 'nature', tags: [], wip: false, type: 'unit', cost: { energy: 5, elements: [{ type: 'nature', amount: 3 }] }, attack: 0, hp: 4, keywords: { taunt: true, spike: 3, tough: 1 } },
  ...
  { id: 'guardian-crab', name: 'Guardian Crab', element: 'earth', text: 'Taunt. Tough 2.', tags: [], wip: false, type: 'unit', cost: { energy: 6, elements: [{ type: 'earth', amount: 2 }] }, attack: 0, hp: 5, keywords: { taunt: true, tough: 2 } },
  ...
  { id: 'blaze-hound', name: 'Blaze Hound', element: 'fire', tags: [], wip: false, type: 'unit', cost: { energy: 2 }, attack: 4, hp: 2, keywords: {} },
  { id: 'inferno-ox', name: 'Inferno Ox', element: 'fire', tags: [], wip: false, type: 'unit', cost: { energy: 4 }, attack: 5, hp: 4, keywords: {} },
  ...
  { id: 'current-rider', name: 'Current Rider', element: 'water', tags: [], wip: false, type: 'unit', cost: { energy: 2 }, attack: 3, hp: 3, keywords: {} },
  ...
  { id: 'worldheart-wyrm', name: 'Worldheart Wyrm', element: 'nature', text: 'Strike Through. Bloodlust: +1/+1 per kill.', tags: [], wip: false, type: 'unit', cost: { energy: 13, elements: [{ type: 'nature', amount: 2 }] }, attack: 7, hp: 7, keywords: { strikeThrough: true, bloodlust: { buff: { attack: 1, hp: 1 } } } },
  { id: 'grove-elder', name: 'Elder of the Grove', element: 'nature', text: 'Producer: 2 energy/turn. On play: draw a card.', tags: [], wip: false, type: 'unit', cost: { energy: 3, elements: [{ type: 'nature', amount: 2 }] }, attack: 1, hp: 5, keywords: {}, onPlay: [{ kind: 'draw', amount: 1 }], onAttack: [], endOfTurn: [{ kind: 'energyNext', amount: 2 }], startOfTurn: [] },
