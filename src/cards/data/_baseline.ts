...
const rawCards = [
  ...
  { id: 'mana-geyser', name: 'Mana Geyser', element: 'nature', text: 'Grants Producer: 1 Nature/turn.', tags: [], wip: false, type: 'foundation', cost: { energy: 3 }, attack: 0, hp: 3, keywords: { producer: { amount: 1 } }, grants: { endOfTurn: [{ kind: 'energy', amount: 1, element: 'nature' }] } },
